...
@section('content')
    ...
    <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
        <div class="my-auto">
            <h5 class="page-title fs-21 mb-1">{{ __('New Transfer') }}</h5>
        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card custom-card">
                <div class="card-body">
                    <form action="{{ route('transfer.store') }}" class="row g-3" method="POST">
                        @csrf
                        <div class="col-md-3">
                            <div class="mb-3">
                        ...
                        <div class="table-responsive">
                            <table class="table text-nowrap">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">{{ __('Transfer Qty') }}</th>
            ...
            $(document).on('keyup', '.qty', function(){
                ...
                if(parseInt(qty) > parseInt(stock)) {
                    Swal.fire({
                        icon: 'warning',
                        title: 'Oops...',
                        text: '{{ __('Transfer Quantity cannot be greater than stock quantity!') }}',
                    })
                    $(this).val(1);
                }
            })
